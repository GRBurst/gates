...
{	
    ...
    if (uRadius > 82 ){
    	color = mix(vec4(cos(fUV.x * 6.282) * 0.02 + 0.2314, cos(fUV.x * 6.282) * 0.08 + 0.4369, cos(fUV.x * 6.282) * 0.1666 + 0.8333, 1.0), vec4(texture(textureSky, vec3(fUV, uTime / 112)).rrr, 1.0 * gauss), smoothstep(0.5, 0.9, testVal  * gauss));
    ...
    //	color = mix(vec4(cos(fUV.x * 6.282) * 0.05 + 0.2314, cos(fUV.x * 6.282) * 0.12 + 0.4369, cos(fUV.x * 6.282) * 0.2666 + 0.7333, 1.0), vec4(texture(textureSky, vec3(fUV, uTime / 64)).rrr, 1), smoothstep(0.6, 0.9, texture(textureSky, vec3(fUV, uTime / 64)).r) );
    	...
    	{ 
    		color = mix(vec4(cos(fUV.x * 6.282) * 0.02 + 0.2314, cos(fUV.x * 6.282) * 0.08 + 0.4369, cos(fUV.x * 6.282) * 0.1666 + 0.8333, 1.0), vec4(texture(textureSky, vec3(fUV, uTime / 128)).rrr, 0.8 * gauss), smoothstep(0.6, 1.0, testVal  * gauss));
    	}
    	else
    	{ 
    		color = mix(vec4(cos(fUV.x * 6.282) * 0.02 + 0.2314, cos(fUV.x * 6.282) * 0.08 + 0.4369, cos(fUV.x * 6.282) * 0.1666 + 0.8333, 1.0), vec4(texture(textureSky, vec3(fUV, uTime / 96)).rrr, 0.5 * gauss), smoothstep(0.5, 0.8, testVal  * gauss));
    	}
